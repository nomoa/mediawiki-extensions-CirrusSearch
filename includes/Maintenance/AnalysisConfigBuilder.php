...
class AnalysisConfigBuilder {
	...
	/**
	 * @var boolean true if icu folding s requested and available
	 */
	private $icuFolding;
	...
	/**
	 * Determine if ascii folding shoud be used
	 * @param string[] $plugins list of intelled elasticsearch plugins
